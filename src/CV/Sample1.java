...
public class Sample1 {
	...
	private void initialize() {
		...
		lblObjectives.setFont(new Font("Helvetica", Font.BOLD, 20));
		lblObjectives.setForeground(Color.BLACK);
		lblObjectives.setBackground(Color.WHITE);
		lblObjectives.setBounds(50, 215, 327, 31);
		panel.add(lblObjectives);
		
		JLabel lblOrganizedAndMotivated = new JLabel("A hardworking and focused individual seeking opportunities to work in a well-reputed");
		...
		JLabel lblAndOrganizationalSkills = new JLabel("organization with a dedicated team, under the guidance of an insightful leader to learn and get");
		lblAndOrganizationalSkills.setFont(new Font("Arial", Font.PLAIN, 14));
		lblAndOrganizationalSkills.setBounds(50, 288, 615, 23);
		panel.add(lblAndOrganizationalSkills);
		
		JLabel lblSeekingToJoin = new JLabel("experience in my work.");
		...
		lblAcademicQualification.setForeground(Color.BLACK);
		lblAcademicQualification.setFont(new Font("Helvetica", Font.BOLD, 20));
		...
		lblGraduation.setForeground(Color.BLACK);
		...
		lblIntermediate.setForeground(Color.BLACK);
		...
		lblMatriculation.setForeground(Color.BLACK);
		...
		lblExperience.setFont(new Font("Helvetica", Font.BOLD, 20));
		...
		lblSkills.setFont(new Font("Helvetica", Font.BOLD, 20));
		...
		lblLanguages.setForeground(Color.BLACK);
		lblLanguages.setFont(new Font("Helvetica", Font.BOLD, 20));
		...
		lblSports.setForeground(Color.BLACK);
		lblSports.setFont(new Font("Helvetica", Font.BOLD, 20));
