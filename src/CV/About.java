...
public class About {
	...
	private void initialize() {
		...
		txtrThisAppIs.setText("This app is Created By Navneet ");
		...
		txtrUserNameIqra.setText("User Name: developer");
		...
		txtrPasswordIqra.setText("Password: developer");
